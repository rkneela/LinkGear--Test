...
export class ClaimDetailComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,private http: Http, private globals: Globals, private oothService: OothService,
    ...
    this.route.queryParams.subscribe(params => {
      ...
      //GetMainCategoryName(CatName : String){
    ...
    this.bigchainService.getTransactionsById(id)
      .subscribe(
        ...
        data => {
         ...
         // this.model.businessMainCategory
          this.model = claim;

        // console.log(this.model.businessMainCategory);
